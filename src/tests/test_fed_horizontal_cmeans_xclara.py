...
plan_path = './plans/plan_federated_cmeans_horizontal_xclara.json'

fl_plan = load_plan(plan_path, server_class=FederatedHorizontalCMServer, client_class=FederatedHorizontalCMClient)
